...
class RootController:
	...
	def view():
		...
		return render_template('index.html', error=None, all_ok=None)
	...
	def signup(form):
		for item in form.values():
			if item == '' or item == None:
				...
				return render_template('index.html', error=error, all_ok=None)
		...
		all_ok = "C'est Good!"
		return render_template('index.html', all_ok=all_ok, error=None)
